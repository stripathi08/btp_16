# forked from github.com/npow/memN2N
...
class Model:
    ...
    def build_network(self, nonlinearity):
        ...
        #  trial preds
        self.trial_pred = theano.function([], probas, givens=givens, on_unused_input='ignore')
    ...
    def compute_f1(self, dataset):
        ...
        # y_pred1 = np.concatenate([self.predict(dataset, i) for i in xrange(n_batches)])
        #
    ...
    def train(self, n_epochs=100, shuffle_batch=False):
        ...
        while (epoch < n_epochs):
            ...
            # y_pred = self.predict(self.data['test'], 0)
            # self.predict(self.data['test'], 0)
            # print y_pred
            # a = y_pred.astype(np.int32) - 1
            # print a
        # done as per no of batches. each batch size = 32. Each epoch reiteration gives 32 results.
        # self.set_shared_variables(self.data['test'], 0)
        y_pred = self.predict(self.data['test'], 0)
        # print y_pred
        a = y_pred.astype(np.int32) - 1
        # print a
        ...
        for i in xrange(32):
            ...
            print 'predicted answer: ', self.lb.classes_[a[i]]
            # exit()
...
def main():
    ...
    if args.train_file == '' or args.test_file == '':
        args.train_file = "./tasks_1-20_v1/en/qa2_two-supporting-facts_train.txt"
        args.test_file = "./tasks_1-20_v1/en/qa2_two-supporting-facts_test.txt"
